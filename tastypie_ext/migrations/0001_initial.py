...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tastypie_ext_apitoken', (
        ...
        db.send_create_signal(u'tastypie_ext', ['ApiToken'])


    def backwards(self, orm):
        # Deleting model 'ApiToken'
        db.delete_table(u'tastypie_ext_apitoken')
    ...
    models = {
        ...
        u'tastypie_ext.apitoken': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'api_tokens'", 'to': u"orm['auth.User']"})
        }
    }

    complete_apps = ['tastypie_ext']